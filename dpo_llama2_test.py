...
def get_stack_exchange_paired(
    ...
    Prompts are structured as follows:
      "Question: " + <prompt> + "\n\nAnswer: "
    """
    dataset = load_dataset( "lvwerra/stack-exchange-paired", 'default-data_dir=data%2Frl')['train']
...
if __name__ == "__main__":
    ...
    #eval_dataset = Subset(eval_dataset, indices=range(100))
